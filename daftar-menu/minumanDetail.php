...
if(isset($_GET['id'])) {
	...
	$minuman = query("SELECT * FROM minuman WHERE id='$id'") ? query("SELECT * FROM minuman WHERE id='$id'")[0] : null;
}
if(empty($minuman) || !isset($minuman)){
...
?>
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Detail Minuman</h1>
          <div class="row">
          	<div class="col-md-8">
          		<div class="card mb-3">
				  <div class="row no-gutters">
				    ...
				    <div class="col-md-8">
				      <div class="card-body">
				        <h5 class="card-title"><?= $minuman['makanan']; ?></h5>
				        <p class="card-text"><?= $minuman['deskripsi']; ?></p>
				        <div class="d-flex justify-content-between mt-5">
				        	<div>
				        		<a href="minuman.php" class="btn btn-info"><i class="fas fa-arrow-circle-left"></i> Kembali</a>
				        	</div>
				        	<div>
