...
<html>
<head>
	<title>Kontak Restoran kami</title>
		<!--Boostrap-->
...
<body>
	...
	<div class="container">
		<p class="text-center m1 font-weight-bold" style="font-size: 35px;">Kontak Kami</p><hr style="width: "><br>
			<div class="col-md-7">
				...
				<div class="form-group">
					<label style="font-size: 25px;"><strong>Pesan</strong></label>
					<textarea type="text" class="form-control" rows="18"></textarea>
				</div><br>
