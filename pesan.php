...
<body>
	...
	<div class="container">
		<p class="text-center m1 font-weight-bold" style="font-size: 35px;">Pesan Makanan</p><hr><br>
			<div class="col-md-7">
				<div class="form-group">
					<label style="font-size: 25px;"><strong>Nama Lengkap</strong></label>
					<input type="text" name="" class="form-control" placeholder="Nama">
				</div><br>
				<div class="form-group">
					<label style="font-size: 25px;"><strong>No Handphone</strong></label>
					<input type="number" name="" class="form-control" placeholder="12345">
				</div><br>
				<div class="form-group">
					<label style="font-size: 25px;"><strong>Email</strong></label>
					<input type="email" name="" class="form-control" placeholder="pengguna@wow.com">
				</div><br><br>
				<p class="text-left font-weight-bold" style="font-size: 28px;">Pilih Makanan dari menu</p><hr><br><br>
				<div class="form-group">
			      	<label for="inputState" style="font-size: 25px;">Pilih Menu</label>
			     	 <select id="inputState" class="form-control">
			        	<option selected>Choose</option>
			        	<option>Omelet</option>
			        	<option>Nasi Goreng</option>
			        	<option>Fish n Chips</option>
			        	<option>Roti Bakar</option>
			        	<option>Telur dan daging</option>
			        	<option>Sereal</option>
			        	<option>Steak</option>
			        	<option>Spagetti</option>
			        	<option>Makaroni</option>
			        	<option>Risotto</option>
			        	<option>Tiramissu</option>
			        	<option>Strawberry Cheese Cake</option>
			        	<option>Eskrim Goreng</option>
			        	<option>Pie Lemon</option>
			        	<option>Choc a block</option>
			        	<option>Kripik Kentang</option>
			        	<option>Siomai</option>
			        	<option>Biskuit Coklat</option>
			        	<option>Pizza</option>
			        	<option>Cilok</option>
			        	<option>Es Teh</option>
			        	<option>Es Jeruk</option>
			        	<option>Es Teler</option>
			        	<option>Es Coklat</option>
			...
			<a href="terkirim.php" class="btn btn-primary" style="padding: 10px 30px;">Kirim</a>
		</div>
	</div><br><br><br><br><br>
	<div class="container">
		<div class="row">
